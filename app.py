...
WATERMARK_LINE = (
    "Generated by Stephen Wahlquist AI Consulting — book a free call to get a "
    "custom version tuned to your voice and MLS: calendar.app.google/m55qGMREuvoXpx5j9"
)
WATERMARK = "\n\n" + WATERMARK_LINE
...
Rules: No markdown, no asterisks. Bullets start with "- ". Be direct."""
    ...
    try:
        ...
        if summary_text:
            summary_text = summary_text + WATERMARK
